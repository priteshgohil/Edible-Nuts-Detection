...
def process_video(vid_path, result_folder):
    ...
    vid_frame = get_frame_index(hist_correlation,hist_kldiv)

    #save the result
    video_name = vid_path.split("/")[-1]
    save_location = result_folder+video_name
    plot_for_report(vid_path,hist_correlation,hist_kldiv,vid_frame,save_location, offset=10)
...
if __name__ == "__main__":
    ...
    if (opt.mode == 2):
        ...
        process_video(opt.path, result_folder)
